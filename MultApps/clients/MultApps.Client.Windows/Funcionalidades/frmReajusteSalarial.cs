...
namespace MultApps.Client.Windows.Funcionalidades
{
    ...
    public partial class frmReajusteSalarial : Form
    {
        ...
        {
                RadioButton rbnTurno = grbTurno.Controls.OfType
                <RadioButton>().SingleOrDefault(r => r.Checked);
                RadioButton rbnCategoria = grbCategoria.Controls.OfType<RadioButton>().SingleOrDefault(r => r.Checked);
        ...
        RadioButton rbnCategoria, double horasTrabalhadas,double valorSalarioMinimo)
        {
